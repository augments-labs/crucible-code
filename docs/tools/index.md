...
something to answer them. Three change nothing outside crucible: `todo_write`
puts down the plan, and you read it above the prompt; `ask_user` puts a question
to you and waits; and `tool_search` finds the tools that are not in the list —
