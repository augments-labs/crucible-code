...
pub use sandbox::{
    ...
    SandboxCredentialProvenance, SandboxEnvironment, SandboxError, SandboxFact, SandboxFactKind,
    SandboxFailureKind, SandboxFailurePhase, SandboxFeature, SandboxFilesystemAccess,
