...
///
/// The list is the one [`log`] writes, and for the reason written there: it
/// comes down from the directory before this call returns, so there is no
/// moment at which the log carries anything wider.
