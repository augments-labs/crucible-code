...
use crucible_tools::{Ask, Mode, Remember, Sensitivity, Settled, Verdict};
...
pub(crate) const WRITTEN: &str = "a-written-key";
...
impl Sample {
    ...
    pub(crate) fn user_file(&self) -> PathBuf {
    ...
    pub(crate) fn stored(&self, provider: &str) -> StoredCredentials {
    ...
    pub(crate) fn installed(&self, directory: &str, manifest: &str) {
    ...
    pub(crate) fn settles(&self, call: &ToolCall, sensitivity: &Sensitivity) -> Settled {
        struct Nobody;
