...
use crucible_sandbox::{
    SandboxAudit, SandboxCleanup, SandboxError, SandboxFactKind, SandboxFilesystemAccess,
    SandboxFilesystemProvenance, SandboxFilesystemRule, SandboxLifecycle, SandboxManifest,
...
impl Owned {
    ...
    fn request(&self, enabled: bool, maximum: Option<u64>) -> SandboxRequest {
