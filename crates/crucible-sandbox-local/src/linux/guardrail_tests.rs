...
use crucible_sandbox::{
    SandboxCommand, SandboxCommandPolicy, SandboxCommandRule, SandboxEnvironment, SandboxError,
    SandboxGuardrailEffect, SandboxManifest, SandboxPolicy, SandboxRequest, SandboxService,
};
...
fn session_denying(sample: &Sample, rule: &[&str]) -> Box<dyn crucible_sandbox::SandboxSession> {
