...
use crucible_sandbox::{SandboxDomainPolicy, SandboxNetworkEndpoint};
...
fn target_endpoint(
    target: &str,
    tunnel: bool,
    provenance: crucible_sandbox::SandboxNetworkProvenance,
...
mod tests {
    use super::*;
    use crucible_sandbox::{SandboxDomainPattern, SandboxNetworkProvenance};
