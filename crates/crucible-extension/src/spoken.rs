...
///
/// ```compile_fail,E0277
/// use crucible_extension::Trouble;
///
...
impl Spoken {
    ...
    /// [`Written`](crucible_transport::Written), and a payload that could put
    /// one here would be a payload choosing where crucible's frames end.
    #[must_use]
