...
//! boundary [`EXTENSION_MANIFEST_BYTES`] sets — so a planted tree of ten
...
//!
//! Where to sweep is handed in rather than worked out. The directory somebody's
//! home is under is a settings question, and a discovery that resolved one
//! would be reading configuration in order to answer a question about files.
//!
...
use crate::{EXTENSION_MANIFEST_BYTES, ExtensionError, ExtensionManifest};
