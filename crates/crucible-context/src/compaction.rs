...
/// from code, not from the model: [`is_structured`] refuses a recap with that
/// line of its own, and text that only mentions the heading does not open the
/// list.
