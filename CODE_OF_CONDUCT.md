...
When an incident does occur, it is important to report it promptly. To report a possible violation, email **<pnjoyim@augmentslabs.com>**. Include what happened, where it happened, when, and links or screenshots if you have them. Reports are read only by the Community Moderators. Do not open a public issue to report a violation.

The Community Moderators are the maintainers of this project. If a report concerns a moderator, that person takes no part in the investigation or the decision.
...
For this project, community spaces include the GitHub repository — issues, pull requests, discussions, code review and commit messages — and any channel the project runs elsewhere.
